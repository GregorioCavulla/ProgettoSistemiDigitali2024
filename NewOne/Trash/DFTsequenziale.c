...
int main(int argc, char *argv[] ) {
    ...
    snprintf(outputFile, sizeof(outputFile), "./output/sequenziale_output_%s.wav", timestamp);
    snprintf(reportFile, sizeof(reportFile), "./reports/sequenziale_report_%s.txt", timestamp);
