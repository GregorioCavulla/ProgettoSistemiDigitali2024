...
int main(int argc, char *argv[]) {
    ...
    snprintf(outputFile, sizeof(outputFile), "./output/cuda_v2.2_output_%s.wav", timestamp);
    snprintf(reportFile, sizeof(reportFile), "./reports/cuda_v2.2_report_%s.txt", timestamp);
